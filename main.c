...
void TextoReal(char* txt2, int* x){
  char aux[50000]="*** START OF THE PROJECT GUTENBERG EBOOK THE KING JAMES BIBLE ***";
  
}

void interfaz(){
  printf("________________________________\n");
  printf("    INDEXADOR DE LIBROS V1.0    \n");
  printf("________________________________\n");
